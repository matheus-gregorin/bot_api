...
Route::group(['prefix' => 'auth'], function(){
    Route::post('/login', [OperatorsControllers::class, 'login']);
    Route::post('/logout/{operatorUuid}', [OperatorsControllers::class, 'logout']);
    Route::post('/valid', [OperatorsControllers::class, 'valid']);
});
